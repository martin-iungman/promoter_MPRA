...
-   2 Replicates (1 and 2), sequenced separately.

-   6 samples each (Gates 1 to 6)
...
```{r}
#| label: fig-01
#| fig-cap: Distribution of the quality of reads for each sample, in both read orientation. Q.10=Q<10, Q.10.20= 10>Q>20, Q.20.30 = 20>Q>30, Q.30=Q>30.
...
2- Change the name of the FASTQ files (this may not be necessary anymore)
